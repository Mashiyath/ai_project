...
message = tk.Label(window, text="METROPALITAN UNIVERSITY" ,bg="white"  ,fg="black"  ,width=30  ,height=2,font=('Times New Roman', 20, 'bold')) 

message.place(x=500, y=760)

message = tk.Label(window, text="ATTENDANCE MANAGEMENT PORTAL" ,bg="white"  ,fg="black"  ,width=40  ,height=1,font=('Times New Roman', 35, 'bold underline')) 
message.place(x=200, y=20)


lbl = tk.Label(window, text="Enter Your College ID",width=20  ,height=2  ,fg="black"  ,bg="white" ,font=('Times New Roman', 25, ' bold ') ) 
...
lbl2 = tk.Label(window, text="Enter Your Name",width=20  ,fg="black"  ,bg="white"    ,height=2 ,font=('Times New Roman', 25, ' bold ')) 
...
lbl3 = tk.Label(window, text="NOTIFICATION",width=20  ,fg="black"  ,bg="white"  ,height=2 ,font=('Times New Roman', 25, ' bold ')) 
lbl3.place(x=1060-x_cord, y=200-y_cord)

message = tk.Label(window, text="" ,bg="white"  ,fg="red"  ,width=30  ,height=2, activebackground = "white" , font=('Times New Roman', 15, ' bold ')) 
...
takeImg = tk.Button(window, text="IMAGE CAPTURE BUTTON", command=TakeImages  ,fg="white"  ,bg="#00aeff"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
takeImg.place(x=245-x_cord, y=425-y_cord)
trainImg = tk.Button(window, text="MODEL TRAINING BUTTON", command=TrainImages  ,fg="white"  ,bg="#00aeff"  ,width=25  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
trainImg.place(x=645-x_cord, y=425-y_cord)
trackImg = tk.Button(window, text="ATTENDANCE MARKING BUTTON", command=TrackImages  ,fg="white"  ,bg="red"  ,width=30  ,height=2, activebackground = "pink" ,font=('Times New Roman', 15, ' bold '))
...
quitWindow.place(x=700, y=700-y_cord)
